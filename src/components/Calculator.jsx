...
export default function Calculator() {
	...
	return (
		<div data-testid="calcBody-test" className="CalculatorBody">
			<img src={startupgif} alt="Start Up" className="startupImg"/>
			<div className="overlayAesthethic"></div>
			<div className="stripe"></div>
			<div className="calculatorScreen">
				<p data-testid="display-test" className="inputtedText" >{displayData}</p>
			</div>
			<div className="calculatorLayout">
				<div data-testid="clear-test" className="Clear key" onClick={() => inputData("C")}><p>C</p></div>
				...
				<div data-testid="mul-test" className="multiplication key" onClick={() => inputData("*")}><p>×</p></div>
				...
				<div data-testid="minus-test" className="substraction key" onClick={() => inputData("-")}><p>-</p></div>
				<div data-testid="oneKey-test" className="one key" onClick={() => inputData("1")}><p>1</p></div>
				<div data-testid="twoKey-test" className="two key" onClick={() => inputData("2")}><p>2</p></div>
				<div data-testid="threeKey-test" className="three key" onClick={() => inputData("3")}><p>3</p></div>
				<div data-testid="sum-test" className="sum key" onClick={() => inputData("+")}><p>+</p></div>
				<div data-testid="zeroKey-test" className="zero key" onClick={() => inputData("0")}><p>0</p></div>
				<div className="dot key" onClick={() => inputData(".")}><p>.</p></div>
				<div data-testid="equals-test" className="equals key" onClick={() => inputData("=")}><p>=</p></div>
			</div>
		</div>
